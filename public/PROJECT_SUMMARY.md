...
- 📑 **SYNOPSIS.md**: Formal academic & project synopsis.
- 📘 **README.md**: Developer setup and API documentation.
- 📓 **stock_analysis_prediction.ipynb**: Complete pre-executed Jupyter Notebook (492 KB).
- 🐍 **server.py** & **api/index.py**: FastAPI backend web server & Vercel serverless entrypoint.
- 🌐 **public/index.html**: Interactive Web Dashboard frontend.
